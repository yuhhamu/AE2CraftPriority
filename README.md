...
- Minecraft 1.20.1
- Minecraft Forge 47.4.6 or later (tested with 47.4.10)
- Applied Energistics 2 for Minecraft 1.20.1 (15.x series; tested with 15.4.10)
...
The following AE2 addon mods have been confirmed to work alongside this mod without issues.

以下のAE2アドオンMODを同時に導入しても問題なく動作することを確認しています。

- **AdvancedAE**: Priority also applies to the execution order between Quantum Computers (this does not interfere with AdvancedAE's own logic for choosing between a vanilla CPU and a Quantum Computer).
- **Mega Cells**: MEGA Crafting CPUs use the same mechanism as vanilla Crafting CPUs, so priority applies with no extra setup.
